...
2.  Calculate the number of votes candidates in PartyA received.

```{r}

```

3.  On average, how many votes did candidates in PartyA receive?

```{r}

```

4.  On average, did PartyB get more votes than PartyA per candidate?
